...
<div class="custom-container mx-auto pt-0 lg:pt-0 pb-8 lg:pb-8">
    <div class="flex justify-between items-baseline px-4 font-vietnampro text-[#2c3e50]">
        <h1 class="text-xl lg:text-3xl font-bold pb-1 lg:pb-10">Inside Dhaka City</h1>
    ...
    <div class="relative w-full overflow-x-hidden">
        <div class="flex overflow-x-auto overflow-y-hidden gap-4 space-x-2 lg:space-x-4 p-4 scroll-container">
            @foreach ($turfs->where('district', 'Dhaka')->take(8) as $turf)
                <div
