...
@extends('pages.turfAdmin.dashboard')
    ...
    <div class="flex-grow pt-8 p-6 bg-gray-100 overflow-y-scroll">
        ...
        <div class="space-x-4">
            <div class="p-6 mt-32 lg:mt-10 rounded-xl max-xl:w-full flex justify-center">
                <div class="bg-gray-100 max-xl:w-full">
                    <!-- Header -->
                    <header class="bg-gradient-to-r from-green-400 to-blue-500 py-6 text-white text-center rounded-2xl">
                        <h1 class="text-3xl max-xl:text-5xl font-bold font-Poppins">Profile</h1>
                    </header>
                    ...
                    <main class="py-8">
                        ...
                        <div class="bg-white rounded-lg p-6 max-xl:p-8 font-Poppins">
                            <div class="flex flex-col items-center mb-4">
                                <img class="h-16 w-16 max-xl:h-52 max-xl:w-52
                                 rounded-full mr-4 max-xl:mb-4 bg-red-50 p-3"
                                    src="img/{{ $user->pro_pic }}" alt="Profile Picture">
                                <div class="text-center space-y-2">
                                    <h2 class="text-2xl text-gray-600 max-xl:text-5xl font-semibold">
                                        {{ $user->f_name }} {{ $user->l_name }}</h2>
                                    <p class="text-gray-600 max-xl:text-4xl">{{ $user->email }}</p>
                                </div>
                                <div
                                    class="max-xl:flex max-xl:justify-center max-xl:items-center max-xl:mt-6 max-xl:space-x-6 glassy-bg rounded-full px-6 py-3">
                                    {{-- facebook --}}
                                    <a href="{{ json_decode($user->social_links, true)['facebook'] ?? '#' }}"><img
                                            src="icons/facebook-icon.svg" alt=""></a>
                                    {{-- instagram --}}
                                    <a href="{{ json_decode($user->social_links, true)['instagram'] ?? '' }}"><img
                                            src="icons/instagram-icon.svg" alt=""></a>
                                    {{-- twitter --}}
                                    <a href="{{ json_decode($user->social_links, true)['twitter'] ?? '' }}"><img
                                            src="icons/twitter-icon.svg" alt=""></a>
                                    {{-- linkedin --}}
                                    <a href="{{ json_decode($user->social_links, true)['linkedin'] ?? '' }}"><img
                                            src="icons/linkedin-icon.svg" alt=""></a>
                                </div>
                            </div>
                            <div class="max-xl:mt-16">
                                <div class="">
                                    <h3
                                        class="text-lg font-bold mb-2 max-xl:text-5xl max-xl:text-center max-xl:bg-gray-900/10 max-xl:text-white max-xl:py-6 max-xl:rounded-2xl max-xl:mb-10 bg-gradient-to-r from-green-400 to-blue-500">
                                        Personal
                                        Information</h3>
                                    <div
                                        class="max-xl:flex max-xl:items-center max-xl:space-x-4 max-xl:mb-6 shadow flex items-center rounded-2xl px-10 bg-slate-100 py-5 space-x-6">
                                    ...
                                    <div
                                        class="mt-6 max-xl:flex max-xl:flex-col max-xl:mb-6 shadow flex items-center rounded-2xl bg-slate-100 py-6 px-10 space-x-6">
