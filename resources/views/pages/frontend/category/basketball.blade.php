<body>
    <title>Basketball Category - TurfEase</title>
</body>
@include('pages.admin.home.homecss')
@include('pages.admin.home.header')

<div class="custom-container mx-auto col-lg-12 p-3 mt-6">
    <div class="flex items-center mb-6 lg:mb-6">
        <p class="text-lg lg:text-xl font-semibold mr-3">Category: Basketball</p>
    </div>
...
@include('pages.admin.home.footer')
