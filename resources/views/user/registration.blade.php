        ...
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                <div class="hidden mx-auto md:block w-1/2 bg-slate-200 py-10 px-10">
                    ...
                    <h2 class="text-center text-[#06B24E] font-sans text-3xl font-bold">Elevate Your Game to a New Dimension</h2>
                </div>
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    ...
                    <div>
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-3 relative">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" name="f_name"
                                        ...
                                        placeholder="John" value="{{old('f_name')}}">
                                </div>
                            ...
                            <div class="w-1/2 px-3 mb-3 relative">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" name="l_name"
                                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                        placeholder="Smith" value="{{old('l_name')}}">
                                </div>
                                <span class="text-xs font-semibold text-red-400 absolute left-4">
                                    @error('l_name')
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3">
                                {{-- <button
                                    ...
                                    NOW</button> --}}
                                <input type="submit" class="block w-full cursor-pointer max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" value="Register Now">
                            </div>
                        </div>
                    </div>
                </div>
